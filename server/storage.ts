  ...
  private getSampleProducts(): Product[] {
    return [
      ...
      },
      {
        ...
        referenceImageUrl: "/assets/Porta Biberones_Bordado.jpg",
        category: "Loncheras",
        animalType: "Osita",
        colors: ["Beige", "Rosa"],
        inStock: true,
      ...
      },
      {
        ...
        referenceImageUrl: "/assets/Lonchera baul.jpg",
        category: "Loncheras",
        animalType: "Osito",
        colors: ["Beige", "Azul"],
        inStock: true,
      ...
      },
      {
        ...
        referenceImageUrl: "/assets/Bolso Rosadito Bordado Minifantasy.jpg",
        category: "Colección",
        animalType: "Varios",
      ...
      {
        id: 15,
        name: "Organizador de Higiene Premium",
        ...
        referenceImageUrl: "/assets/Organizador_Bordado.jpg",
        category: "Organizadores",
        animalType: null,
        colors: ["Rosa", "Beige"],
        inStock: true,
      ...
      },
      {
        id: 16,
        name: "Bolso Mariposa",
        description: "Hermoso bolso con diseño de mariposa - Disponible con y sin bordado personalizado",
        price: 180000.00,
        imageUrl: "/assets/Bolsito Mariposa.jpg",
        blankImageUrl: "/assets/Bolso Mariposa sin Bordar.jpg",
        referenceImageUrl: "/assets/Bolsito Mariposa.jpg",
        category: "Bolsos",
        animalType: "Mariposa",
